...
**AI algorithms screen the entire corporate registry continuously,** flagging companies that match high-risk indicators. The new screening criteria target companies where foreigners hold 0.001%–49.99% of shares, capturing the standard 49:51 nominee structure threshold that was previously considered safe, whilst also flagging companies with foreign authorised directors even where no foreign equity exists. **46,918 entities** have been identified nationally under this screening, with approximately **1,000 prioritised** for immediate investigation. Registered addresses carry the same weight, since DBD guidance flags any address where five or more companies are registered as high-risk, and the [Krabi raid linking more than 500 firms across Krabi, Phuket and Surat Thani to a single accounting firm](/resources/krabi-ghost-office-nominee-raid) uncovered a staged office fitted with non-operational computers and over 100 company nameplates.
...
**The property does not transfer to the foreign investor upon dissolution.** It reverts to the Thai shareholders of record or becomes subject to court-ordered disposal. The foreign investor's entire investment is at risk of total loss. Formal compliance with the 49% shareholding limit does not avert that outcome: the Interior Ministry froze 126 rai on Koh Lanta worth THB 2.146 billion in July 2026 after tracing [circular cross-shareholdings that gave one foreign national 99.87% effective control of the landholding company](/resources/krabi-2-1bn-land-seizure-nominee-cross-shareholding), with compulsory disposal expected to take six months to one year.
...
**For investors currently in nominee structures,** conversion to Better-than-Freehold™ spans approximately 6–8 weeks and can be financed through SPH Trustees. The conversion process is detailed in our guide to [nominee structure conversion](/resources/nominee-structure-conversion-legal-process-thailand).
...
- [Nominee Company Risks Thailand 2025](/resources/nominee-company-risks-thailand) - Criminal prosecution and penalties for illegal nominee structures under current enforcement
...
- [DBD Order 2/2568](/resources/dbd-order-2-2568-company-registration-thailand) - New registration rules strengthening the investigation gateway
- [Nominee Structure Conversion](/resources/nominee-structure-conversion-legal-process-thailand) - Step-by-step guide to converting from nominee to compliant structure
