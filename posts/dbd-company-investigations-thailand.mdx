...
**Companies with filing arrears are particularly exposed.** Entities with at least 3 consecutive years of outstanding balance sheet filings risk administrative cancellation by the DBD, a process that, once initiated, can take 1–2 years to resolve through the courts, leaving the underlying property or business in legal limbo throughout. The DBD has since acted on that exposure at scale, publishing on 19 August 2026 a named list of 11,234 Bangkok entities headed for [strike-off into "abandoned" status](/resources/dbd-abandoned-status-11234-bangkok-entities), 8,446 of them non-filers for three straight years, with 90 days to object and with directors and shareholders staying personally liable once the company can no longer sign, sell or mortgage.
...
**Approximately 1,000 of the 46,918 flagged entities have been prioritised for immediate investigation,** with the remainder subject to ongoing monitoring. The prioritisation criteria are not publicly disclosed, but enforcement patterns suggest geographic concentration in Phuket, Koh Samui, Phangan, and Hua Hin, with the Surat Thani "blueprint" now being applied across the entire southern tourist corridor. The screened population has widened well beyond that cohort since, the DBD confirming in February 2026 that [117,496 foreign-invested companies sit in the 0.01% to 49.99% shareholding band](/resources/dbd-targets-110000-companies-nominee-shell-accounts) it now examines systematically, with 21,459 already flagged for detailed review and enforcement concentrated across 12 key provinces.
...
**AMLO** leads complex money laundering investigations and can issue administrative restraint orders to freeze assets for up to 90 days without a prior court order; permanent asset seizure and forfeiture require a subsequent Civil Court order. **The Economic Crime Suppression Division (ECSD)** handles large-scale nominee network dismantlement, as demonstrated by the THB 2 billion Rayong/Chonburi operation in May 2025\. **The Department of Special Investigation (DSI)** pursues complex prosecutions requiring specialist expertise. **Provincial task forces** led by governors and local agencies conduct targeted inspections, with enforcement operations documented across Phuket (July 2025, 200+ suspects detained), Koh Samui/Phangan (October 2025, 7,000+ businesses flagged), and Hua Hin (January 2026, systematic investigations ongoing). The Hua Hin phase opened with paperwork rather than raids, [formal compliance requests to property-owning companies](/resources/huahin-nominee-company-enforcement) across Prachuap Khiri Khan giving more than 7,000 Prachuap Khiri Khan entities a one-year deadline to evidence genuine Thai shareholder investment with share registers, investment receipts, bank statements and financial statements.
...
- [Nominee Company Risks Thailand 2025](/resources/nominee-company-risks-thailand) - Criminal prosecution and penalties for illegal nominee structures
...
- [Foreign Business Act Constraints Thailand](/resources/foreign-business-act-thailand) - Regulatory framework governing foreign business participation
- [DBD Order 2/2568](/resources/dbd-order-2-2568-company-registration-thailand) - New registration rules strengthening the DBD enforcement gateway
