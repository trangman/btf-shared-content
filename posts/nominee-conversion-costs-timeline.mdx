...
Where a proposed Land Code amendment would replace forced disposal with forfeiture to the State without proceeds, the message is consistent even before enactment: a shareholder-scheduled exit preserves tax timing and choice of replacement structure, whilst an investigation-scheduled exit is usually the worst timing possible. The contrast is already concrete under current law: as we covered when the [Department of Lands tightened its checks on nominee landholding](/resources/land-department-nominee-landholding-crackdown), compulsory disposal gives an owner found to hold land unlawfully a defined period to sell and, failing that, empowers the Director-General to sell the land on their behalf, so control over the timing and potentially the terms of the transaction passes to the State.
