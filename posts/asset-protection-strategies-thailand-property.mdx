...
**The seizure process is administrative, not judicial.** AMLO identifies assets connected to suspected predicate offences, issues a freezing order, and takes control of the property through administrative action. The property owner must then prove the assets are not connected to the offence, reversing the normal burden of proof. That reversal decides cases: in August 2026 AMLO's Transaction Committee referred thirteen matters covering 376 assets to prosecutors for forfeiture because the [owners' objections failed to show the property was unconnected to the offences](/resources/amlo-land-seizures-forfeiture-burden-of-proof), and in the same round land with structures was seized on the same footing as cash and gold.
...
- [Nominee Company Risks Thailand 2025](/resources/nominee-company-risks-thailand) - Criminal prosecution and penalties creating the asset protection imperative
...
- [DBD Company Investigations Thailand](/resources/dbd-targets-110000-companies-nominee-shell-accounts) - How the DBD's investigation apparatus detects and targets nominee companies
