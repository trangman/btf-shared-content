...
| **Tax clearance completion** | Foreign shareholder shares transferred to TIN; promissory notes cancelled | On clearance |
...
**Land Office due diligence** verifies the title, access rights, and building permits. This typically takes one day. **Company due diligence** reviews balance sheets at the DBD; companies with 3–4 years of filing arrears risk cancellation by the DBD, which can take 1–2 years to resolve through the courts. Overall, due diligence spans 1–2 weeks. Because that complexity drives both fee and duration, our guide to [what actually drives divestment costs and timelines](/resources/nominee-conversion-costs-timeline) explains why a high-risk property-owning company carrying outstanding debt, multiple Thai shareholders, or incomplete records commonly runs to sixteen weeks rather than eight, and why no adviser can quote a fixed price before reviewing the existing structure.
...
- [DBD Order 2/2568](/resources/dbd-order-2-2568-company-registration-thailand) - New registration rules retrospectively affecting existing nominee structures
