...
ogTitle: "Sap Ing Sith Thailand – What Agents Won't Tell You About ROLA"
...
<FAQAccordion faqs={[
  ...
  },
  {
    ...
    answer: "Buildings revert to the landowner under Section 11 unless otherwise agreed. No statutory compensation exists for improvements. A foreign investor may lose a multi-million baht villa without any legal remedy."
  },
  {
  ...
  },
  {
    ...
    answer: "Better-than-Freehold™ is a fully compliant ownership structure providing perpetual 30-year leases with enforceable renewal options, registered security interests through Clear Blue Security Agents, asset protection via independent trustees, and access to offshore financing up to 50% LTV. It delivers lifetime security without relying on landowner cooperation."
  },
  {
